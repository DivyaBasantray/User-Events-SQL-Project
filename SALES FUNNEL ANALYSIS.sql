...
-- DEFININING SALES FUNNEL AND ITS DIFFERENT STAGES
...
SELECT 
    ...
    stage_5_purchase,
	ROUND(stage_4_payment * 100 / stage_4_payment) AS payment_to_purchase_rate,
...
SELECT
    ...
    ROUND(AVG(TIMESTAMPDIFF(purchase_time, car_time, MINUTE)),2) AS avg_cart_to_purchase_minutes,
